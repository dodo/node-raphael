var raphael = require('node-raphael'), // https://github.com/dodo/node-raphael.git
    connect = require('connect');      // https://github.com/senchalabs/connect.git



raphael.load(function (err) {
    ...
    server = connect.createServer(
        connect.router(function (app) {
            ...
            app.get('/raphael.svg', function (req, res) {
                res.writeHead(200, { 'Content-Type': 'image/svg+xml' });

                var svg = raphael.svg.generate(320, 320, function (r) {
//  mostly http://raphaeljs.com/gear.html (without animation)
...
// logo
var logo = r.set(
r.rect(13, 13, 116, 116, 30).attr({stroke: "none", fill: "#fff", rotation: 45, opacity: .2}),
