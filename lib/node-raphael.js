...
var jsdom = _require('jsdom', 'jsdom/lib/jsdom'),
    ...
    domToHtml = _require('jsdom/lib/jsdom/jsdom/browser/domtohtml',
                         'jsdom/jsdom/browser/domtohtml').domToHtml,

    patch = require('./raphael/patch')(jsdom, domToHtml, overload),
...
exports.svg.generate = function (width, height) {
    ...
    var doc = win.document = patch.document(
                jsdom.jsdom("<html><body></body></html>")),
        nav = win.navigator;
    doc.implementation.addFeature(
        "http://www.w3.org/TR/SVG11/feature#BasicStructure",
        "1.1");
    var paper = svg.raphael(win, doc, nav)(0, 0, width || 42, height || 42);
    args.callback(paper);
